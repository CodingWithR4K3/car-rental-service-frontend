...
import com.kodilla.car_rental.client.CarClient;
...
import com.kodilla.car_rental.dto.Status;
...
public class CarView extends VerticalLayout {
    ...
    private final TextField chassisType = new TextField("Chassis Type");
    ...
    private final TextField chasssisTypeUpdate = new TextField("Chassis type");
    ...
    public CarView(CarClient carClient, RentalClient rentalClient, RentalView rentalView) {
        ...
        newCarDialogLayout.add(vin, brand, model, productionYear, fuelType, engineCapacity, chassisType, mileage,
        ...
        updateCarDialogLayout.add(vinUpdate, brandUpdate, modelUpdate, productionYearUpdate, fuelTypeUpdate,
                engineCapacityUpdate, chasssisTypeUpdate, mileageUpdate, costPerDayUpdate, confirmUpdateButton);
    ...
    private boolean areUpdatedCarFieldsFilled() {
        return (!vinUpdate.getValue().equals("") &&
                ...
                !chasssisTypeUpdate.getValue().equals("") &&
    ...
    private void bindFields() {
        ...
        binderForSavingCar.forField(chassisType)
                .bind(CarDto::getChassisType, CarDto::setChassisType);
        ...
        binderForUpdatingCar.forField(engineCapacityUpdate)
                .bind(CarDto::getEngineCapacity, CarDto::setEngineCapacity);
        binderForUpdatingCar.forField(chasssisTypeUpdate)
                .bind(CarDto::getChassisType, CarDto::setChassisType);
